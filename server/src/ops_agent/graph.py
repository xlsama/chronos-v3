...
from src.ops_agent.nodes.confirm_context import confirm_context_node
...
def build_graph():
    ...
    # Edges
    graph.add_edge("gather_context", "confirm_context")
    graph.add_edge("confirm_context", "main_agent")
...
def compile_graph(checkpointer=None):
    ...
    return graph.compile(
        ...
        interrupt_before=["human_approval", "ask_human", "confirm_context"],
    )
